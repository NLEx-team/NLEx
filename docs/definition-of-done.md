...
7. **Testing Evidence**: Test results and coverage are preserved as evidence in the PR or CI logs.
8. **Changelog**: User-visible changes are recorded in the `CHANGELOG.md` file under the `[Unreleased]` section.
