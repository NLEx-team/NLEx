...
class OrchestratorService:
    ...
    async def execute_user_query(self, query: str):
        ...
        return await self._processing_loop(query, filtered_schema)
    ...
    async def handle_clarification(self, clarification: str):
        ...
        return await self._processing_loop(None, self.full_schema) 

    async def _processing_loop(self, user_prompt: Optional[str], schema_override: Optional[Dict[str, Any]] = None):
        """
