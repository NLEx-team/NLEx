...
* **Issue Templates Directory:** GitHub Issue Templates *(dynamic management component, removed link)*
...
* **Shared Process Specification Guide:** Process Requirements *(Referenced tracking source)*
