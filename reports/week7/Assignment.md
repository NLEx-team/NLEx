...
4. The Demo Day slide deck PDF and the accompanying video must be submitted on Moodle by the end of Week 7, Sunday, `23:59`.
...
14. Suggested Week 7 rehearsal presentation structure:
...
15. Suggested Demo Day presentation structure:

    * Title slide (1 slide):
      * Project title and team number (at least)
    * Intro (1 slide):
      * Team members
      * Their Scrum and technical roles
      * Contribution (briefly)
    * Project context (1 slide):
      * The problem and its importance
      * Key stakeholders (customer, end-users)
    * Requirements (1 slide):
      * FR and QR listed and prioritized (MoSCoW)
    * Roadmap (1 slide):
      * MVPs and what you delivered in each MVP (briefly)
    * Handover status (1 slide):
      * When will the customer use / do they use now
      * Known limitations
      * Further work
    * Demo (1 slide):
      * Pre-recorded video with comments
    * Reflection (1 slide)
      * Lessons learned:
         * From problems: which problems did you encounter, how you resolved them, and what you learned?
         * From good decisions: what did you do which was really useful and what you learned?
      * What would you do differently if you were starting the project again?
    * Links (1 slide)
      * link and QR code to the deployed product
      * link and QR code to the repo

16. Keep the presentation concise and narrative-driven. Do not rely on simply reading notes from a phone or laptop.

17. Rehearse for timing. Make sure the talk fits the Week 7 rehearsal limit and the Week 8 Demo Day limit.

18. Explain the problem and project context clearly. Do not assume that reviewers remember the project details or understand the customer context.

19. Explain clearly whether the customer is actually using the product already, and if not, why not.

20. During Q&A, the person who worked on the relevant part should answer where possible. One person should not answer all questions for the team.

21. Add slide numbers so that the examiners can refer to particular slides.
